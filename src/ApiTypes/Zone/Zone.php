 ...
 *
 * @todo
 * Currently Zone has been written to be read-only.  However, the API has write
 * capabilities.
 */
class Zone {
  private $zoneId;
  ...
  public function __construct(array $cloudflare_zone_settings) {
    $this->zoneId = $cloudflare_zone_settings['id'];
  ...
  /**
   * Get's the zones isMobileRedirectEnabled.
   *
   * @return string
